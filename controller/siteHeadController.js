...
async function addSiteHead(user) {
    try {
        ...
        .query("INSERT INTO SiteHead (FirstName, LastName, MobileNumber, Field, FieldSiteName, Password, ConfirmPassword) VALUES (@FirstName, @LastName, @MobileNumber, @Field, @FieldSiteName, @Password, @ConfirmPassword)");
