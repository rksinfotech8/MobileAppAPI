...
router.route('/fieldstate/all').get((request, response) => {
   db.getFieldStates()
       .then(result => {
...
router.route('/fieldstate/:id').get((request, response) => {
...
router.route('/fieldstate/create').post((request, response) => {
...
router.route('/fieldstate/update/:id').put((request, response) => {
   const { id } = request.params;
...
// Delete a fieldState
router.route('/fieldstate/delete/:id').delete((request, response) => {
   const { id } = request.params;
...
router.route('/fieldstate').post(upload.single('FieldImage'), (request, response) => {
